...
public class DocuportsConstants {

    public static final  String USERNAME_CLIENT="b1g1_client@gmail.com";

    public  static  final String  ERROR_MESSAGE_FOR_EMPTY_PASSWORD="Pleaase enter your password";
    ...
    public  static  final  String EMAIL_FOR_RESET_PASSWORD="forgotpasswordgl@gmail.com";
